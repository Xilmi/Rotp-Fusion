...
// BR: Guardian Space Monsters
// BR: Guardian Space Monsters Captain, use SpacePiratesCaptain.java as template
public class GuardianMonsterCaptain implements Base, ShipCaptain {
	@SuppressWarnings("unused")
	private SpaceMonster monster; // for potential later use

	public GuardianMonsterCaptain (SpaceMonster monster) 			{
		this.monster = monster;
	}

	@Override public StarSystem retreatSystem(StarSystem fr)		{ return null; }
	...
	@Override public FlightPath pathTo(CombatStack s, int x, int y)	{ return null; }

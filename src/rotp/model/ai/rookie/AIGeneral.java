...
public class AIGeneral implements Base, General {
    ...
    private void orderInvasionFleet(EmpireView v, StarSystem sys, float enemyFleetSize) {
        ...
        if (empire.sv.hasFleetForEmpire(sys.id, empire))
            ...
            launchGroundTroops(v, sys, troops/empire.combatTransportPct());
    ...
    //compatibility to Diplomat-Diplomat
    @Override
    public Empire bestVictim() {
        ...
        // BR: Not used... (No more?) Commented to save time
    ...
    public int additionalColonizersToBuild(boolean returnPotentialUncolonizedInstead)
    {
        ...
        int additional = 0;
        float colonizerRange = empire.shipDesignerAI().BestDesignToColonize().range();

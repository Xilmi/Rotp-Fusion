...
public class CustomAbilitiesFactory implements InterfaceOptions{
...
//		settingList = PlayerRaceCustomizationUI.playerInstance().cr.copy().settingList;
//	}
//	private CustomAbilitiesFactory copy() {
//		settingList = PlayerRaceCustomizationUI.playerInstance().cr.copy();
//	}
	...
	public static String getRandomAlienRaceKey() {
		CustomAbilitiesFactory cr = new CustomAbilitiesFactory();
		cr.getFullList();

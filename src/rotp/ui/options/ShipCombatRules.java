...
final class ShipCombatRules implements IOptionsSubUI {
	...
	@Override public SafeListPanel optionsMap()	{
		...
		list1.addAll(AllSubUI.getHandle(COMBAT_ASTEROID_UI_KEY).getUiMajor());
		list1.add(headerSpacer50);
		list1.addAll(AllSubUI.getHandle(COMBAT_XILMI_AI_UI_KEY).getUiMajor());
		list1.add(headerSpacer50);
		list1.addAll(AllSubUI.getHandle(COMBAT_TIMING_UI_KEY).getUiMajor());
		map.add(list1);

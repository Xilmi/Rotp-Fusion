 ...
 * @since   1.8
 */
// BR: copied SplittableRandom to make it serializable.
public final class SerialRandom implements Serializable{
     ...
     */
    private SerialRandom(long seed, long gamma) {
        this.seed = seed;
        this.gamma = gamma;
    }
     ...
     */
    public SerialRandom() { // emulate defaultGen.split()
     ...
     */
    public SerialRandom split() {
        return new SerialRandom(nextLong(), mixGamma(nextSeed()));
    }
